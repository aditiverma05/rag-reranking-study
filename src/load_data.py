...
def load_hotpot(n_samples=150, seed=42):
    ...
    for item in sampled:
        ...
        records.append({
            'id': item['id'],
            'question': item['question'],
            'context': ' '.join(context_parts)[:3000],
...
if __name__ == "__main__":
    ...
    print("Done!")
    print(f"SQuAD: {len(squad_df)} rows")
    print(f"HotpotQA: {len(hotpot_df)} rows")
    print("Sample question:", squad_df['question'].iloc[0])